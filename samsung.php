...
<body>
    ...
    <!-- connect to database, query sanpham with HangDTH="samsung", then display the result using html and css--> 
        ...
        <div id="main_content">
            ...
            while($sanpham=$resultLietKeSP->fetch_array(MYSQLI_ASSOC)){ ?>
                    <li class="phone_list_element">
                        ...
                        <a href="<?php echo "chitietSanpham?MaSP=".$sanpham["MaSP"] ?>" onclick="watchProductDetail(this)">
